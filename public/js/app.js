 ...
 */
Vue.component('review-form', __webpack_require__(7));
...
window.app = new Vue({
    ...
    created: function created() {
        ...
        console.log('yeetn');
        fetch("http://resto.local/api/menu").then(function (res) {
            return res.json();
        }).then(function (json) {
            _this.menu = json;
        });
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return fetch("http://resto.local/api/reviews").then(function (res) {
                                    return res.json();
                                }).then(function (json) {
                                    _this2.reviews = json;
                                });
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-87fdc4e2", Component.options)
  } else {
    hotAPI.reload("data-v-87fdc4e2", Component.options)
  }
...
var render = function() {
  ...
  return _c("form", { attrs: { id: "review-form", method: "post" } }, [
    _c("input", {
      attrs: { type: "hidden", name: "_token" },
      domProps: { value: _vm.csrf }
    }),
    _vm._v(" "),
    _c("input", { attrs: { type: "text", name: "name", placeholder: "Name" } }),
    _vm._v(" "),
    _c("input", {
      attrs: { type: "email", name: "email", placeholder: "Email" }
    }),
    _vm._v(" "),
    _c("textarea", { attrs: { name: "review", placeholder: "Review" } }),
    _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-87fdc4e2", module.exports)
  }
}
